...
namespace 游戏服务器.窗口视图
{
    partial class ConfigInfoView
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ===== 特殊功能页(全线性标准设计器代码, 可在 VS 设计器显示/编辑) =====
            this.特殊功能页 = new XtraTabPage();
            this.特功子选项卡 = new XtraTabControl();
            this.特殊开关页 = new XtraTabPage();
            this.公会配置页 = new XtraTabPage();
            this.组职业第一 = new GroupControl();
            this.组怪物首杀 = new GroupControl();
            this.组装备首爆 = new GroupControl();
            this.组幸运倍攻 = new GroupControl();
            this.组公会开关 = new GroupControl();
            this.组公会等级 = new GroupControl();
            this.组公会职位 = new GroupControl();
            this.组攻城 = new GroupControl();
            this.chk职业第一 = new CheckEdit();
            this.spn职业0 = new SpinEdit(); this.spn职业1 = new SpinEdit(); this.spn职业2 = new SpinEdit(); this.spn职业3 = new SpinEdit(); this.spn职业4 = new SpinEdit(); this.spn职业5 = new SpinEdit();
            this.lbl职业0 = new LabelControl(); this.lbl职业1 = new LabelControl(); this.lbl职业2 = new LabelControl(); this.lbl职业3 = new LabelControl(); this.lbl职业4 = new LabelControl(); this.lbl职业5 = new LabelControl();
            this.chk怪物首杀 = new CheckEdit(); this.chk首杀货币 = new CheckEdit(); this.chk首杀道具 = new CheckEdit(); this.chk首杀邮件 = new CheckEdit();
            this.spn首杀货币类型 = new SpinEdit(); this.spn首杀货币数量 = new SpinEdit(); this.spn首杀道具编号 = new SpinEdit(); this.spn首杀道具数量 = new SpinEdit();
            this.lbl首杀1 = new LabelControl(); this.lbl首杀2 = new LabelControl(); this.lbl首杀3 = new LabelControl(); this.lbl首杀4 = new LabelControl();
            this.chk装备首爆 = new CheckEdit(); this.chk首爆货币 = new CheckEdit(); this.chk首爆道具 = new CheckEdit(); this.chk首爆邮件 = new CheckEdit();
            this.spn首爆货币类型 = new SpinEdit(); this.spn首爆货币数量 = new SpinEdit(); this.spn首爆道具编号 = new SpinEdit(); this.spn首爆道具数量 = new SpinEdit();
            this.lbl首爆1 = new LabelControl(); this.lbl首爆2 = new LabelControl(); this.lbl首爆3 = new LabelControl(); this.lbl首爆4 = new LabelControl();
            this.chk幸运倍率 = new CheckEdit(); this.lbl幸运头 = new LabelControl(); this.lbl倍率头 = new LabelControl();
            this.spn幸运0 = new SpinEdit(); this.spn幸运1 = new SpinEdit(); this.spn幸运2 = new SpinEdit(); this.spn幸运3 = new SpinEdit(); this.spn幸运4 = new SpinEdit(); this.spn幸运5 = new SpinEdit(); this.spn幸运6 = new SpinEdit(); this.spn幸运7 = new SpinEdit(); this.spn幸运8 = new SpinEdit(); this.spn幸运9 = new SpinEdit();
            this.spn倍率0 = new SpinEdit(); this.spn倍率1 = new SpinEdit(); this.spn倍率2 = new SpinEdit(); this.spn倍率3 = new SpinEdit(); this.spn倍率4 = new SpinEdit(); this.spn倍率5 = new SpinEdit(); this.spn倍率6 = new SpinEdit(); this.spn倍率7 = new SpinEdit(); this.spn倍率8 = new SpinEdit(); this.spn倍率9 = new SpinEdit();
            this.lbl档0 = new LabelControl(); this.lbl档1 = new LabelControl(); this.lbl档2 = new LabelControl(); this.lbl档3 = new LabelControl(); this.lbl档4 = new LabelControl(); this.lbl档5 = new LabelControl(); this.lbl档6 = new LabelControl(); this.lbl档7 = new LabelControl(); this.lbl档8 = new LabelControl(); this.lbl档9 = new LabelControl();
            this.chk公会等级特效 = new CheckEdit(); this.chk公会职位特效 = new CheckEdit();
            this.spn等级1 = new SpinEdit(); this.spn等级2 = new SpinEdit(); this.spn等级3 = new SpinEdit(); this.spn等级4 = new SpinEdit(); this.spn等级5 = new SpinEdit(); this.spn等级6 = new SpinEdit();
            this.lbl等级1 = new LabelControl(); this.lbl等级2 = new LabelControl(); this.lbl等级3 = new LabelControl(); this.lbl等级4 = new LabelControl(); this.lbl等级5 = new LabelControl(); this.lbl等级6 = new LabelControl();
            ...
            this.特殊功能页.Text = "特殊功能";
            this.特功子选项卡.Name = "特功子选项卡";
            this.特功子选项卡.Dock = DockStyle.Fill;
            this.特殊开关页.Name = "特殊开关页";
            this.特殊开关页.Text = "特殊开关";
            this.公会配置页.Name = "公会配置页";
            this.公会配置页.Text = "公会配置";
            this.特功子选项卡.TabPages.AddRange(new XtraTabPage[] { this.特殊开关页, this.公会配置页 });
            this.特殊功能页.Controls.Add(this.特功子选项卡);
            this.xtraTabControl1.TabPages.Add(this.特殊功能页);
            // ---- 组: 职业第一 ----
            this.组职业第一.Name = "组职业第一";
            this.组职业第一.Text = "职业第一设置 (战力榜榜首, 编号0=不启用)";
            this.组职业第一.Location = new Point(10, 8);
            this.组职业第一.Size = new Size(322, 222);
            this.特殊开关页.Controls.Add(this.组职业第一);
            this.chk职业第一.Name = "chk职业第一"; this.chk职业第一.Text = "开启职业第一机制"; this.chk职业第一.Location = new Point(10, 26); this.chk职业第一.Size = new Size(300, 20);
            this.lbl职业0.Text = "战士第一BUFF编号"; this.lbl职业0.Location = new Point(14, 53);
            this.lbl职业1.Text = "法师第一BUFF编号"; this.lbl职业1.Location = new Point(14, 77);
            this.lbl职业2.Text = "刺客第一BUFF编号"; this.lbl职业2.Location = new Point(14, 101);
            this.lbl职业3.Text = "弓手第一BUFF编号"; this.lbl职业3.Location = new Point(14, 125);
            this.lbl职业4.Text = "道士第一BUFF编号"; this.lbl职业4.Location = new Point(14, 149);
            this.lbl职业5.Text = "龙枪第一BUFF编号"; this.lbl职业5.Location = new Point(14, 173);
            this.spn职业0.Name = "spn职业0"; this.spn职业0.Location = new Point(194, 50); this.spn职业0.Size = new Size(114, 20); this.spn职业0.Properties.IsFloatValue = false; this.spn职业0.Properties.MaxValue = 65535m;
            this.spn职业1.Name = "spn职业1"; this.spn职业1.Location = new Point(194, 74); this.spn职业1.Size = new Size(114, 20); this.spn职业1.Properties.IsFloatValue = false; this.spn职业1.Properties.MaxValue = 65535m;
            this.spn职业2.Name = "spn职业2"; this.spn职业2.Location = new Point(194, 98); this.spn职业2.Size = new Size(114, 20); this.spn职业2.Properties.IsFloatValue = false; this.spn职业2.Properties.MaxValue = 65535m;
            this.spn职业3.Name = "spn职业3"; this.spn职业3.Location = new Point(194, 122); this.spn职业3.Size = new Size(114, 20); this.spn职业3.Properties.IsFloatValue = false; this.spn职业3.Properties.MaxValue = 65535m;
            this.spn职业4.Name = "spn职业4"; this.spn职业4.Location = new Point(194, 146); this.spn职业4.Size = new Size(114, 20); this.spn职业4.Properties.IsFloatValue = false; this.spn职业4.Properties.MaxValue = 65535m;
            this.spn职业5.Name = "spn职业5"; this.spn职业5.Location = new Point(194, 170); this.spn职业5.Size = new Size(114, 20); this.spn职业5.Properties.IsFloatValue = false; this.spn职业5.Properties.MaxValue = 65535m;
            this.组职业第一.Controls.AddRange(new Control[] { this.chk职业第一, this.lbl职业0, this.spn职业0, this.lbl职业1, this.spn职业1, this.lbl职业2, this.spn职业2, this.lbl职业3, this.spn职业3, this.lbl职业4, this.spn职业4, this.lbl职业5, this.spn职业5 });
            // ---- 组: 怪物首杀 ----
            this.组怪物首杀.Name = "组怪物首杀";
            this.组怪物首杀.Text = "怪物首杀设置 (全服首杀BOSS)";
            this.组怪物首杀.Location = new Point(342, 8);
            this.组怪物首杀.Size = new Size(322, 244);
            this.特殊开关页.Controls.Add(this.组怪物首杀);
            this.chk怪物首杀.Name = "chk怪物首杀"; this.chk怪物首杀.Text = "开启怪物首杀功能"; this.chk怪物首杀.Location = new Point(10, 26); this.chk怪物首杀.Size = new Size(300, 20);
            this.chk首杀货币.Name = "chk首杀货币"; this.chk首杀货币.Text = "发放货币奖励"; this.chk首杀货币.Location = new Point(10, 50); this.chk首杀货币.Size = new Size(300, 20);
            this.chk首杀道具.Name = "chk首杀道具"; this.chk首杀道具.Text = "发放道具奖励"; this.chk首杀道具.Location = new Point(10, 74); this.chk首杀道具.Size = new Size(300, 20);
            this.chk首杀邮件.Name = "chk首杀邮件"; this.chk首杀邮件.Text = "道具走邮件发放"; this.chk首杀邮件.Location = new Point(10, 98); this.chk首杀邮件.Size = new Size(300, 20);
            this.lbl首杀1.Text = "货币类型(0银1金3元宝)"; this.lbl首杀1.Location = new Point(14, 125);
            this.lbl首杀2.Text = "货币数量"; this.lbl首杀2.Location = new Point(14, 149);
            this.lbl首杀3.Text = "道具编号"; this.lbl首杀3.Location = new Point(14, 173);
            this.lbl首杀4.Text = "道具数量"; this.lbl首杀4.Location = new Point(14, 197);
            this.spn首杀货币类型.Name = "spn首杀货币类型"; this.spn首杀货币类型.Location = new Point(194, 122); this.spn首杀货币类型.Size = new Size(114, 20); this.spn首杀货币类型.Properties.IsFloatValue = false; this.spn首杀货币类型.Properties.MaxValue = 99m;
            this.spn首杀货币数量.Name = "spn首杀货币数量"; this.spn首杀货币数量.Location = new Point(194, 146); this.spn首杀货币数量.Size = new Size(114, 20); this.spn首杀货币数量.Properties.IsFloatValue = false; this.spn首杀货币数量.Properties.MaxValue = 2000000000m;
            this.spn首杀道具编号.Name = "spn首杀道具编号"; this.spn首杀道具编号.Location = new Point(194, 170); this.spn首杀道具编号.Size = new Size(114, 20); this.spn首杀道具编号.Properties.IsFloatValue = false; this.spn首杀道具编号.Properties.MaxValue = 2000000000m;
            this.spn首杀道具数量.Name = "spn首杀道具数量"; this.spn首杀道具数量.Location = new Point(194, 194); this.spn首杀道具数量.Size = new Size(114, 20); this.spn首杀道具数量.Properties.IsFloatValue = false; this.spn首杀道具数量.Properties.MaxValue = 9999m;
            this.组怪物首杀.Controls.AddRange(new Control[] { this.chk怪物首杀, this.chk首杀货币, this.chk首杀道具, this.chk首杀邮件, this.lbl首杀1, this.spn首杀货币类型, this.lbl首杀2, this.spn首杀货币数量, this.lbl首杀3, this.spn首杀道具编号, this.lbl首杀4, this.spn首杀道具数量 });
            // ---- 组: 装备首爆 ----
            this.组装备首爆.Name = "组装备首爆";
            this.组装备首爆.Text = "装备首爆设置 (全服首爆贵重物品)";
            this.组装备首爆.Location = new Point(342, 260);
            this.组装备首爆.Size = new Size(322, 244);
            this.特殊开关页.Controls.Add(this.组装备首爆);
            this.chk装备首爆.Name = "chk装备首爆"; this.chk装备首爆.Text = "开启装备首爆功能"; this.chk装备首爆.Location = new Point(10, 26); this.chk装备首爆.Size = new Size(300, 20);
            this.chk首爆货币.Name = "chk首爆货币"; this.chk首爆货币.Text = "发放货币奖励"; this.chk首爆货币.Location = new Point(10, 50); this.chk首爆货币.Size = new Size(300, 20);
            this.chk首爆道具.Name = "chk首爆道具"; this.chk首爆道具.Text = "发放道具奖励"; this.chk首爆道具.Location = new Point(10, 74); this.chk首爆道具.Size = new Size(300, 20);
            this.chk首爆邮件.Name = "chk首爆邮件"; this.chk首爆邮件.Text = "道具走邮件发放"; this.chk首爆邮件.Location = new Point(10, 98); this.chk首爆邮件.Size = new Size(300, 20);
            this.lbl首爆1.Text = "货币类型(0银1金3元宝)"; this.lbl首爆1.Location = new Point(14, 125);
            this.lbl首爆2.Text = "货币数量"; this.lbl首爆2.Location = new Point(14, 149);
            this.lbl首爆3.Text = "道具编号"; this.lbl首爆3.Location = new Point(14, 173);
            this.lbl首爆4.Text = "道具数量"; this.lbl首爆4.Location = new Point(14, 197);
            this.spn首爆货币类型.Name = "spn首爆货币类型"; this.spn首爆货币类型.Location = new Point(194, 122); this.spn首爆货币类型.Size = new Size(114, 20); this.spn首爆货币类型.Properties.IsFloatValue = false; this.spn首爆货币类型.Properties.MaxValue = 99m;
            this.spn首爆货币数量.Name = "spn首爆货币数量"; this.spn首爆货币数量.Location = new Point(194, 146); this.spn首爆货币数量.Size = new Size(114, 20); this.spn首爆货币数量.Properties.IsFloatValue = false; this.spn首爆货币数量.Properties.MaxValue = 2000000000m;
            this.spn首爆道具编号.Name = "spn首爆道具编号"; this.spn首爆道具编号.Location = new Point(194, 170); this.spn首爆道具编号.Size = new Size(114, 20); this.spn首爆道具编号.Properties.IsFloatValue = false; this.spn首爆道具编号.Properties.MaxValue = 2000000000m;
            this.spn首爆道具数量.Name = "spn首爆道具数量"; this.spn首爆道具数量.Location = new Point(194, 194); this.spn首爆道具数量.Size = new Size(114, 20); this.spn首爆道具数量.Properties.IsFloatValue = false; this.spn首爆道具数量.Properties.MaxValue = 9999m;
            this.组装备首爆.Controls.AddRange(new Control[] { this.chk装备首爆, this.chk首爆货币, this.chk首爆道具, this.chk首爆邮件, this.lbl首爆1, this.spn首爆货币类型, this.lbl首爆2, this.spn首爆货币数量, this.lbl首爆3, this.spn首爆道具编号, this.lbl首爆4, this.spn首爆道具数量 });
            // ---- 组: 幸运倍攻 (10 档 幸运值/倍率 表) ----
            this.组幸运倍攻.Name = "组幸运倍攻";
            this.组幸运倍攻.Text = "幸运倍攻设置 (幸运值达档位时按倍率增伤)";
            this.组幸运倍攻.Location = new Point(674, 8);
            this.组幸运倍攻.Size = new Size(330, 360);
            this.特殊开关页.Controls.Add(this.组幸运倍攻);
            this.chk幸运倍率.Name = "chk幸运倍率"; this.chk幸运倍率.Text = "开启幸运倍率功能"; this.chk幸运倍率.Location = new Point(10, 26); this.chk幸运倍率.Size = new Size(308, 20);
            this.lbl幸运头.Text = "幸运值"; this.lbl幸运头.Location = new Point(70, 53);
            this.lbl倍率头.Text = "倍率"; this.lbl倍率头.Location = new Point(205, 53);
            this.lbl档0.Text = "档1"; this.lbl档0.Location = new Point(14, 75);
            this.lbl档1.Text = "档2"; this.lbl档1.Location = new Point(14, 99);
            this.lbl档2.Text = "档3"; this.lbl档2.Location = new Point(14, 123);
            this.lbl档3.Text = "档4"; this.lbl档3.Location = new Point(14, 147);
            this.lbl档4.Text = "档5"; this.lbl档4.Location = new Point(14, 171);
            this.lbl档5.Text = "档6"; this.lbl档5.Location = new Point(14, 195);
            this.lbl档6.Text = "档7"; this.lbl档6.Location = new Point(14, 219);
            this.lbl档7.Text = "档8"; this.lbl档7.Location = new Point(14, 243);
            this.lbl档8.Text = "档9"; this.lbl档8.Location = new Point(14, 267);
            this.lbl档9.Text = "档10"; this.lbl档9.Location = new Point(14, 291);
            this.spn幸运0.Name = "spn幸运0"; this.spn幸运0.Location = new Point(60, 72); this.spn幸运0.Size = new Size(120, 20); this.spn幸运0.Properties.IsFloatValue = false; this.spn幸运0.Properties.MaxValue = 99999m;
            this.spn幸运1.Name = "spn幸运1"; this.spn幸运1.Location = new Point(60, 96); this.spn幸运1.Size = new Size(120, 20); this.spn幸运1.Properties.IsFloatValue = false; this.spn幸运1.Properties.MaxValue = 99999m;
            this.spn幸运2.Name = "spn幸运2"; this.spn幸运2.Location = new Point(60, 120); this.spn幸运2.Size = new Size(120, 20); this.spn幸运2.Properties.IsFloatValue = false; this.spn幸运2.Properties.MaxValue = 99999m;
            this.spn幸运3.Name = "spn幸运3"; this.spn幸运3.Location = new Point(60, 144); this.spn幸运3.Size = new Size(120, 20); this.spn幸运3.Properties.IsFloatValue = false; this.spn幸运3.Properties.MaxValue = 99999m;
            this.spn幸运4.Name = "spn幸运4"; this.spn幸运4.Location = new Point(60, 168); this.spn幸运4.Size = new Size(120, 20); this.spn幸运4.Properties.IsFloatValue = false; this.spn幸运4.Properties.MaxValue = 99999m;
            this.spn幸运5.Name = "spn幸运5"; this.spn幸运5.Location = new Point(60, 192); this.spn幸运5.Size = new Size(120, 20); this.spn幸运5.Properties.IsFloatValue = false; this.spn幸运5.Properties.MaxValue = 99999m;
            this.spn幸运6.Name = "spn幸运6"; this.spn幸运6.Location = new Point(60, 216); this.spn幸运6.Size = new Size(120, 20); this.spn幸运6.Properties.IsFloatValue = false; this.spn幸运6.Properties.MaxValue = 99999m;
            this.spn幸运7.Name = "spn幸运7"; this.spn幸运7.Location = new Point(60, 240); this.spn幸运7.Size = new Size(120, 20); this.spn幸运7.Properties.IsFloatValue = false; this.spn幸运7.Properties.MaxValue = 99999m;
            this.spn幸运8.Name = "spn幸运8"; this.spn幸运8.Location = new Point(60, 264); this.spn幸运8.Size = new Size(120, 20); this.spn幸运8.Properties.IsFloatValue = false; this.spn幸运8.Properties.MaxValue = 99999m;
            this.spn幸运9.Name = "spn幸运9"; this.spn幸运9.Location = new Point(60, 288); this.spn幸运9.Size = new Size(120, 20); this.spn幸运9.Properties.IsFloatValue = false; this.spn幸运9.Properties.MaxValue = 99999m;
            this.spn倍率0.Name = "spn倍率0"; this.spn倍率0.Location = new Point(190, 72); this.spn倍率0.Size = new Size(120, 20); this.spn倍率0.Properties.IsFloatValue = true; this.spn倍率0.Properties.MaxValue = 100m; this.spn倍率0.Properties.Increment = 0.1m;
            this.spn倍率1.Name = "spn倍率1"; this.spn倍率1.Location = new Point(190, 96); this.spn倍率1.Size = new Size(120, 20); this.spn倍率1.Properties.IsFloatValue = true; this.spn倍率1.Properties.MaxValue = 100m; this.spn倍率1.Properties.Increment = 0.1m;
            this.spn倍率2.Name = "spn倍率2"; this.spn倍率2.Location = new Point(190, 120); this.spn倍率2.Size = new Size(120, 20); this.spn倍率2.Properties.IsFloatValue = true; this.spn倍率2.Properties.MaxValue = 100m; this.spn倍率2.Properties.Increment = 0.1m;
            this.spn倍率3.Name = "spn倍率3"; this.spn倍率3.Location = new Point(190, 144); this.spn倍率3.Size = new Size(120, 20); this.spn倍率3.Properties.IsFloatValue = true; this.spn倍率3.Properties.MaxValue = 100m; this.spn倍率3.Properties.Increment = 0.1m;
            this.spn倍率4.Name = "spn倍率4"; this.spn倍率4.Location = new Point(190, 168); this.spn倍率4.Size = new Size(120, 20); this.spn倍率4.Properties.IsFloatValue = true; this.spn倍率4.Properties.MaxValue = 100m; this.spn倍率4.Properties.Increment = 0.1m;
            this.spn倍率5.Name = "spn倍率5"; this.spn倍率5.Location = new Point(190, 192); this.spn倍率5.Size = new Size(120, 20); this.spn倍率5.Properties.IsFloatValue = true; this.spn倍率5.Properties.MaxValue = 100m; this.spn倍率5.Properties.Increment = 0.1m;
            this.spn倍率6.Name = "spn倍率6"; this.spn倍率6.Location = new Point(190, 216); this.spn倍率6.Size = new Size(120, 20); this.spn倍率6.Properties.IsFloatValue = true; this.spn倍率6.Properties.MaxValue = 100m; this.spn倍率6.Properties.Increment = 0.1m;
            this.spn倍率7.Name = "spn倍率7"; this.spn倍率7.Location = new Point(190, 240); this.spn倍率7.Size = new Size(120, 20); this.spn倍率7.Properties.IsFloatValue = true; this.spn倍率7.Properties.MaxValue = 100m; this.spn倍率7.Properties.Increment = 0.1m;
            ...
            this.组公会开关.Location = new Point(10, 8);
            this.组公会开关.Size = new Size(322, 82);
            this.公会配置页.Controls.Add(this.组公会开关);
            this.chk公会等级特效.Name = "chk公会等级特效"; this.chk公会等级特效.Text = "开启公会等级特效"; this.chk公会等级特效.Location = new Point(10, 26); this.chk公会等级特效.Size = new Size(300, 20);
            this.chk公会职位特效.Name = "chk公会职位特效"; this.chk公会职位特效.Text = "开启公会职位特效"; this.chk公会职位特效.Location = new Point(10, 50); this.chk公会职位特效.Size = new Size(300, 20);
            this.组公会开关.Controls.AddRange(new Control[] { this.chk公会等级特效, this.chk公会职位特效 });
            // ---- 公会等级特效 ----
            this.组公会等级.Name = "组公会等级";
            this.组公会等级.Text = "公会等级特效 (编号0=不启用)";
            this.组公会等级.Location = new Point(10, 98);
            this.组公会等级.Size = new Size(322, 186);
            this.公会配置页.Controls.Add(this.组公会等级);
            this.lbl等级1.Text = "1级行会特效编号"; this.lbl等级1.Location = new Point(14, 29);
            this.lbl等级2.Text = "2级行会特效编号"; this.lbl等级2.Location = new Point(14, 53);
            this.lbl等级3.Text = "3级行会特效编号"; this.lbl等级3.Location = new Point(14, 77);
            this.lbl等级4.Text = "4级行会特效编号"; this.lbl等级4.Location = new Point(14, 101);
            this.lbl等级5.Text = "5级行会特效编号"; this.lbl等级5.Location = new Point(14, 125);
            this.lbl等级6.Text = "6级行会特效编号"; this.lbl等级6.Location = new Point(14, 149);
            this.spn等级1.Name = "spn等级1"; this.spn等级1.Location = new Point(194, 26); this.spn等级1.Size = new Size(114, 20); this.spn等级1.Properties.IsFloatValue = false; this.spn等级1.Properties.MaxValue = 65535m;
            this.spn等级2.Name = "spn等级2"; this.spn等级2.Location = new Point(194, 50); this.spn等级2.Size = new Size(114, 20); this.spn等级2.Properties.IsFloatValue = false; this.spn等级2.Properties.MaxValue = 65535m;
            this.spn等级3.Name = "spn等级3"; this.spn等级3.Location = new Point(194, 74); this.spn等级3.Size = new Size(114, 20); this.spn等级3.Properties.IsFloatValue = false; this.spn等级3.Properties.MaxValue = 65535m;
            this.spn等级4.Name = "spn等级4"; this.spn等级4.Location = new Point(194, 98); this.spn等级4.Size = new Size(114, 20); this.spn等级4.Properties.IsFloatValue = false; this.spn等级4.Properties.MaxValue = 65535m;
            this.spn等级5.Name = "spn等级5"; this.spn等级5.Location = new Point(194, 122); this.spn等级5.Size = new Size(114, 20); this.spn等级5.Properties.IsFloatValue = false; this.spn等级5.Properties.MaxValue = 65535m;
            this.spn等级6.Name = "spn等级6"; this.spn等级6.Location = new Point(194, 146); this.spn等级6.Size = new Size(114, 20); this.spn等级6.Properties.IsFloatValue = false; this.spn等级6.Properties.MaxValue = 65535m;
            this.组公会等级.Controls.AddRange(new Control[] { this.lbl等级1, this.spn等级1, this.lbl等级2, this.spn等级2, this.lbl等级3, this.spn等级3, this.lbl等级4, this.spn等级4, this.lbl等级5, this.spn等级5, this.lbl等级6, this.spn等级6 });
            // ---- 公会职位特效 ----
            this.组公会职位.Name = "组公会职位";
            this.组公会职位.Text = "公会职位特效 (编号0=不启用)";
            this.组公会职位.Location = new Point(342, 8);
            this.组公会职位.Size = new Size(322, 186);
            this.公会配置页.Controls.Add(this.组公会职位);
            this.lbl职位1.Text = "行会会长特效编号"; this.lbl职位1.Location = new Point(14, 29);
            this.lbl职位2.Text = "行会副长特效编号"; this.lbl职位2.Location = new Point(14, 53);
            this.lbl职位3.Text = "行会长老特效编号"; this.lbl职位3.Location = new Point(14, 77);
            this.lbl职位4.Text = "行会监事特效编号"; this.lbl职位4.Location = new Point(14, 101);
            this.lbl职位5.Text = "行会理事特效编号"; this.lbl职位5.Location = new Point(14, 125);
            this.lbl职位6.Text = "行会执事特效编号"; this.lbl职位6.Location = new Point(14, 149);
            this.spn职位1.Name = "spn职位1"; this.spn职位1.Location = new Point(194, 26); this.spn职位1.Size = new Size(114, 20); this.spn职位1.Properties.IsFloatValue = false; this.spn职位1.Properties.MaxValue = 65535m;
            this.spn职位2.Name = "spn职位2"; this.spn职位2.Location = new Point(194, 50); this.spn职位2.Size = new Size(114, 20); this.spn职位2.Properties.IsFloatValue = false; this.spn职位2.Properties.MaxValue = 65535m;
            this.spn职位3.Name = "spn职位3"; this.spn职位3.Location = new Point(194, 74); this.spn职位3.Size = new Size(114, 20); this.spn职位3.Properties.IsFloatValue = false; this.spn职位3.Properties.MaxValue = 65535m;
            this.spn职位4.Name = "spn职位4"; this.spn职位4.Location = new Point(194, 98); this.spn职位4.Size = new Size(114, 20); this.spn职位4.Properties.IsFloatValue = false; this.spn职位4.Properties.MaxValue = 65535m;
            this.spn职位5.Name = "spn职位5"; this.spn职位5.Location = new Point(194, 122); this.spn职位5.Size = new Size(114, 20); this.spn职位5.Properties.IsFloatValue = false; this.spn职位5.Properties.MaxValue = 65535m;
            this.spn职位6.Name = "spn职位6"; this.spn职位6.Location = new Point(194, 146); this.spn职位6.Size = new Size(114, 20); this.spn职位6.Properties.IsFloatValue = false; this.spn职位6.Properties.MaxValue = 65535m;
            this.组公会职位.Controls.AddRange(new Control[] { this.lbl职位1, this.spn职位1, this.lbl职位2, this.spn职位2, this.lbl职位3, this.spn职位3, this.lbl职位4, this.spn职位4, this.lbl职位5, this.spn职位5, this.lbl职位6, this.spn职位6 });
            // ---- 攻城功能 ----
            this.组攻城.Name = "组攻城";
            this.组攻城.Text = "攻城功能 (沙巴克攻城时间)";
            this.组攻城.Location = new Point(342, 202);
            this.组攻城.Size = new Size(322, 162);
            this.公会配置页.Controls.Add(this.组攻城);
            this.lbl攻城1.Text = "攻沙开始时间(时)"; this.lbl攻城1.Location = new Point(14, 29);
            this.lbl攻城2.Text = "攻沙开始时间(分)"; this.lbl攻城2.Location = new Point(14, 53);
            this.lbl攻城3.Text = "攻沙结束时间(时)"; this.lbl攻城3.Location = new Point(14, 77);
            this.lbl攻城4.Text = "攻沙结束时间(分)"; this.lbl攻城4.Location = new Point(14, 101);
            this.lbl攻城5.Text = "攻城持续时间(分)"; this.lbl攻城5.Location = new Point(14, 125);
            this.spn攻沙开始时.Name = "spn攻沙开始时"; this.spn攻沙开始时.Location = new Point(194, 26); this.spn攻沙开始时.Size = new Size(114, 20); this.spn攻沙开始时.Properties.IsFloatValue = false; this.spn攻沙开始时.Properties.MaxValue = 23m;
            this.spn攻沙开始分.Name = "spn攻沙开始分"; this.spn攻沙开始分.Location = new Point(194, 50); this.spn攻沙开始分.Size = new Size(114, 20); this.spn攻沙开始分.Properties.IsFloatValue = false; this.spn攻沙开始分.Properties.MaxValue = 59m;
            this.spn攻沙结束时.Name = "spn攻沙结束时"; this.spn攻沙结束时.Location = new Point(194, 74); this.spn攻沙结束时.Size = new Size(114, 20); this.spn攻沙结束时.Properties.IsFloatValue = false; this.spn攻沙结束时.Properties.MaxValue = 23m;
            ...
            // ===== 假人管理子页(全线性标准设计器代码; 假人配置存独立 CSV, 故本页用独立按钮存/重载, 不走 Settings 的 借鉴_保存) =====
            this.假人页 = new XtraTabPage();
            this.组假人全局 = new GroupControl();
            this.组假人配额 = new GroupControl();
            this.组假人喊话 = new GroupControl();
            this.组假人操作 = new GroupControl();
            this.chk假人启用 = new CheckEdit();
            this.spn假人总数 = new SpinEdit(); this.spn假人最小等级 = new SpinEdit(); this.spn假人最大等级 = new SpinEdit();
            this.spn假人喝药阈值 = new SpinEdit(); this.spn假人上下线间隔 = new SpinEdit(); this.spn假人喊话间隔 = new SpinEdit();
            this.txt假人名字前缀 = new TextEdit();
            this.chk假人喊话 = new CheckEdit(); this.chk假人PK = new CheckEdit();
            this.lbl假人1 = new LabelControl(); this.lbl假人2 = new LabelControl(); this.lbl假人3 = new LabelControl(); this.lbl假人4 = new LabelControl(); this.lbl假人5 = new LabelControl(); this.lbl假人6 = new LabelControl();
            this.memo假人配额 = new MemoEdit(); this.lbl假人配额说明 = new LabelControl();
            this.memo假人喊话 = new MemoEdit();
            this.btn假人保存 = new SimpleButton(); this.btn假人重载 = new SimpleButton(); this.btn假人填充 = new SimpleButton(); this.btn假人下线 = new SimpleButton(); this.btn假人刷新 = new SimpleButton();
            this.lbl假人状态 = new LabelControl();
            this.假人页.Name = "假人页";
            this.假人页.Text = "假人管理";
            this.特功子选项卡.TabPages.Add(this.假人页);
            // -- 组: 假人全局 --
            this.组假人全局.Name = "组假人全局";
            this.组假人全局.Text = "假人全局设置";
            this.组假人全局.Location = new Point(10, 8);
            this.组假人全局.Size = new Size(330, 260);
            this.假人页.Controls.Add(this.组假人全局);
            this.chk假人启用.Name = "chk假人启用"; this.chk假人启用.Text = "启用假人系统"; this.chk假人启用.Location = new Point(12, 26); this.chk假人启用.Size = new Size(300, 20);
            this.lbl假人1.Text = "假人总数(改后需重启)"; this.lbl假人1.Location = new Point(14, 56);
            this.spn假人总数.Name = "spn假人总数"; this.spn假人总数.Location = new Point(190, 53); this.spn假人总数.Size = new Size(120, 20); this.spn假人总数.Properties.IsFloatValue = false; this.spn假人总数.Properties.MaxValue = 5000m;
            this.lbl假人2.Text = "最小 / 最大等级"; this.lbl假人2.Location = new Point(14, 84);
            this.spn假人最小等级.Name = "spn假人最小等级"; this.spn假人最小等级.Location = new Point(190, 81); this.spn假人最小等级.Size = new Size(58, 20); this.spn假人最小等级.Properties.IsFloatValue = false; this.spn假人最小等级.Properties.MaxValue = 255m;
            this.spn假人最大等级.Name = "spn假人最大等级"; this.spn假人最大等级.Location = new Point(252, 81); this.spn假人最大等级.Size = new Size(58, 20); this.spn假人最大等级.Properties.IsFloatValue = false; this.spn假人最大等级.Properties.MaxValue = 255m;
            this.lbl假人3.Text = "名字前缀"; this.lbl假人3.Location = new Point(14, 112);
            this.txt假人名字前缀.Name = "txt假人名字前缀"; this.txt假人名字前缀.Location = new Point(190, 109); this.txt假人名字前缀.Size = new Size(120, 20);
            this.lbl假人4.Text = "喝药血量阈值 %"; this.lbl假人4.Location = new Point(14, 140);
            this.spn假人喝药阈值.Name = "spn假人喝药阈值"; this.spn假人喝药阈值.Location = new Point(190, 137); this.spn假人喝药阈值.Size = new Size(120, 20); this.spn假人喝药阈值.Properties.IsFloatValue = false; this.spn假人喝药阈值.Properties.MaxValue = 100m;
            this.lbl假人5.Text = "上下线间隔 ms"; this.lbl假人5.Location = new Point(14, 168);
            this.spn假人上下线间隔.Name = "spn假人上下线间隔"; this.spn假人上下线间隔.Location = new Point(190, 165); this.spn假人上下线间隔.Size = new Size(120, 20); this.spn假人上下线间隔.Properties.IsFloatValue = false; this.spn假人上下线间隔.Properties.MaxValue = 600000m;
            this.lbl假人6.Text = "喊话间隔 s"; this.lbl假人6.Location = new Point(14, 196);
            this.spn假人喊话间隔.Name = "spn假人喊话间隔"; this.spn假人喊话间隔.Location = new Point(190, 193); this.spn假人喊话间隔.Size = new Size(120, 20); this.spn假人喊话间隔.Properties.IsFloatValue = false; this.spn假人喊话间隔.Properties.MaxValue = 86400m;
            this.chk假人喊话.Name = "chk假人喊话"; this.chk假人喊话.Text = "开启喊话"; this.chk假人喊话.Location = new Point(12, 224); this.chk假人喊话.Size = new Size(130, 20);
            this.chk假人PK.Name = "chk假人PK"; this.chk假人PK.Text = "开启PK(假人互殴)"; this.chk假人PK.Location = new Point(150, 224); this.chk假人PK.Size = new Size(170, 20);
            this.组假人全局.Controls.AddRange(new Control[] { this.chk假人启用, this.lbl假人1, this.spn假人总数, this.lbl假人2, this.spn假人最小等级, this.spn假人最大等级, this.lbl假人3, this.txt假人名字前缀, this.lbl假人4, this.spn假人喝药阈值, this.lbl假人5, this.spn假人上下线间隔, this.lbl假人6, this.spn假人喊话间隔, this.chk假人喊话, this.chk假人PK });
            // -- 组: 假人配额(每行一条文本, 与 假人地图配额.csv 同格式) --
            this.组假人配额.Name = "组假人配额";
            this.组假人配额.Text = "每图配额 (每行: 地图编号,在线数量,是否打怪,是否PK)";
            this.组假人配额.Location = new Point(350, 8);
            this.组假人配额.Size = new Size(340, 260);
            this.假人页.Controls.Add(this.组假人配额);
            this.lbl假人配额说明.Text = "1=是 0=否; 示例  1,20,0,0  /  2,15,1,0"; this.lbl假人配额说明.Location = new Point(12, 26); this.lbl假人配额说明.Size = new Size(320, 16);
            this.memo假人配额.Name = "memo假人配额"; this.memo假人配额.Location = new Point(12, 46); this.memo假人配额.Size = new Size(316, 200);
            this.组假人配额.Controls.AddRange(new Control[] { this.lbl假人配额说明, this.memo假人配额 });
            // -- 组: 假人喊话 --
            this.组假人喊话.Name = "组假人喊话";
            this.组假人喊话.Text = "喊话内容池 (每行一句)";
            this.组假人喊话.Location = new Point(10, 274);
            this.组假人喊话.Size = new Size(330, 170);
            this.假人页.Controls.Add(this.组假人喊话);
            this.memo假人喊话.Name = "memo假人喊话"; this.memo假人喊话.Location = new Point(12, 26); this.memo假人喊话.Size = new Size(306, 130);
            this.组假人喊话.Controls.AddRange(new Control[] { this.memo假人喊话 });
            // -- 组: 假人操作 --
            this.组假人操作.Name = "组假人操作";
            this.组假人操作.Text = "操作 / 状态 (假人配置存独立 CSV)";
            this.组假人操作.Location = new Point(350, 274);
            this.组假人操作.Size = new Size(340, 170);
            this.假人页.Controls.Add(this.组假人操作);
            this.btn假人保存.Name = "btn假人保存"; this.btn假人保存.Text = "保存并重载"; this.btn假人保存.Location = new Point(12, 28); this.btn假人保存.Size = new Size(150, 32);
            this.btn假人重载.Name = "btn假人重载"; this.btn假人重载.Text = "重载CSV"; this.btn假人重载.Location = new Point(172, 28); this.btn假人重载.Size = new Size(100, 32);
            this.btn假人填充.Name = "btn假人填充"; this.btn假人填充.Text = "立即填充"; this.btn假人填充.Location = new Point(12, 66); this.btn假人填充.Size = new Size(100, 30);
            this.btn假人下线.Name = "btn假人下线"; this.btn假人下线.Text = "全部下线"; this.btn假人下线.Location = new Point(122, 66); this.btn假人下线.Size = new Size(100, 30);
            this.btn假人刷新.Name = "btn假人刷新"; this.btn假人刷新.Text = "刷新状态"; this.btn假人刷新.Location = new Point(232, 66); this.btn假人刷新.Size = new Size(100, 30);
            this.lbl假人状态.Name = "lbl假人状态"; this.lbl假人状态.Location = new Point(12, 104); this.lbl假人状态.Size = new Size(320, 56); this.lbl假人状态.AutoSizeMode = DevExpress.XtraEditors.LabelAutoSizeMode.None;
            this.btn假人保存.Click += this.btn假人保存_Click;
            this.btn假人重载.Click += this.btn假人重载_Click;
            this.btn假人填充.Click += this.btn假人填充_Click;
            this.btn假人下线.Click += this.btn假人下线_Click;
            this.btn假人刷新.Click += this.btn假人刷新_Click;
            this.组假人操作.Controls.AddRange(new Control[] { this.btn假人保存, this.btn假人重载, this.btn假人填充, this.btn假人下线, this.btn假人刷新, this.lbl假人状态 });
        ...
        // ===== 假人管理子页 控件字段 =====
        private XtraTabPage 假人页;
        private GroupControl 组假人全局;
        private GroupControl 组假人配额;
        private GroupControl 组假人喊话;
        private GroupControl 组假人操作;
        private CheckEdit chk假人启用;
        private SpinEdit spn假人总数;
        private SpinEdit spn假人最小等级;
        private SpinEdit spn假人最大等级;
        private SpinEdit spn假人喝药阈值;
        private SpinEdit spn假人上下线间隔;
        private SpinEdit spn假人喊话间隔;
        private TextEdit txt假人名字前缀;
        private CheckEdit chk假人喊话;
        private CheckEdit chk假人PK;
        private LabelControl lbl假人1;
        private LabelControl lbl假人2;
        private LabelControl lbl假人3;
        private LabelControl lbl假人4;
        private LabelControl lbl假人5;
        private LabelControl lbl假人6;
        private MemoEdit memo假人配额;
        private LabelControl lbl假人配额说明;
        private MemoEdit memo假人喊话;
        private SimpleButton btn假人保存;
        private SimpleButton btn假人重载;
        private SimpleButton btn假人填充;
        private SimpleButton btn假人下线;
        private SimpleButton btn假人刷新;
        private LabelControl lbl假人状态;
        ...
        // ===== 特殊功能页(对齐参考引擎截图) 控件字段 =====
        private XtraTabPage 特殊功能页;
        private XtraTabControl 特功子选项卡;
        private XtraTabPage 特殊开关页;
        private XtraTabPage 公会配置页;
        private GroupControl 组职业第一;
        ...
        private GroupControl 组攻城;
        private CheckEdit chk幸运倍率;
        private CheckEdit chk职业第一;
        private CheckEdit chk怪物首杀, chk首杀货币, chk首杀道具, chk首杀邮件;
        private CheckEdit chk装备首爆, chk首爆货币, chk首爆道具, chk首爆邮件;
        private CheckEdit chk公会等级特效, chk公会职位特效;
        private SpinEdit spn职业0, spn职业1, spn职业2, spn职业3, spn职业4, spn职业5;
        private SpinEdit spn幸运0, spn幸运1, spn幸运2, spn幸运3, spn幸运4, spn幸运5, spn幸运6, spn幸运7, spn幸运8, spn幸运9;
        private SpinEdit spn倍率0, spn倍率1, spn倍率2, spn倍率3, spn倍率4, spn倍率5, spn倍率6, spn倍率7, spn倍率8, spn倍率9;
        private SpinEdit spn首杀货币类型, spn首杀货币数量, spn首杀道具编号, spn首杀道具数量;
        private SpinEdit spn首爆货币类型, spn首爆货币数量, spn首爆道具编号, spn首爆道具数量;
        ...
        private LabelControl lbl职位1, lbl职位2, lbl职位3, lbl职位4, lbl职位5, lbl职位6;
        private LabelControl lbl攻城1, lbl攻城2, lbl攻城3, lbl攻城4, lbl攻城5;
    }
}
